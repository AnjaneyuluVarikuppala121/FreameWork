...
public class SignupPage {
	...
	public void createUserAccount (String firstName, String lastName, String expextedGender, String phoneNum, String email, String password ) {
		...
		if(gender.equals(expextedGender))
		{
			element.click();
			break;
		}
