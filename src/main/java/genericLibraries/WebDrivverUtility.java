...
public class WebDrivverUtility 
{
	...
	public void dragAnDropAnelement(WebElement element, WebElement target)
	{
		Actions actions = new Actions(driver);
	...
	public void switchToFrome(int index)
	{
	...
	public void switchToChilBrowser() {
